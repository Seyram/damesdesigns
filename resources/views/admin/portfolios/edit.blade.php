    ...
    <div class="card-body">
        <form action="{{ route("admin.portfolios.update", [$portfolio->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                <label for="name">{{ trans('cruds.portfolio.fields.title') }}*</label>
            ...
            <div class="form-group {{ $errors->has('slug') ? 'has-error' : '' }}">
                ...
                <input type="text" id="slug" name="slug" class="form-control" value="{{ old('slug', isset($portfolio) ? $portfolio->slug : '') }}" required>
                @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.portfolio.fields.research_image_helper') }}</span>
            </div>
            ...
            <div class="form-group">
                ...
                @if($errors->has('design_process_image'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group {{ $errors->has('design_iteration_text') ? 'has-error' : '' }}">
                ...
                @endif
                <p class="helper-block">
                    {{ trans('cruds.portfolio.fields.design_iteration_text_helper') }}
                </p>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('context_image') ? 'is-invalid' : '' }}" id="design-system-dropzone">
                </div>
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <input type="testimonial_name" id="testimonial_name" name="testimonial_name" class="form-control" value="{{ old('testimonial_name', isset($portfolio) ? $portfolio->testimonial_name : '') }}">
...
Dropzone.options.challengeDropzone = {
    ...
    init: function () {
@if(isset($portfolio) && $portfolio->challenge_images)
      var files =
        {!! json_encode($portfolio->challenge_images) !!}
          for (var i in files) {
          var file = files[i]
          this.options.addedfile.call(this, file)
