    ...
    <div class="card-body">
        <form action="{{ route("admin.samples.update", [$sample->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('sample_one_title') ? 'has-error' : '' }}">
                <label for="name">{{ trans('cruds.sample.fields.sample_one_title') }}*</label>
            ...
            <div class="form-group {{ $errors->has('sample_one_link') ? 'has-error' : '' }}">
                <label for="name">{{ trans('cruds.sample.fields.sample_one_link') }}*</label>
            ...
            <div class="form-group {{ $errors->has('sample_two_title') ? 'has-error' : '' }}">
                <label for="sample_two_title">{{ trans('cruds.sample.fields.sample_two_title') }}*</label>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('sample_one_image') ? 'is-invalid' : '' }}" id="context-dropzone">
                </div>
            ...
            <div class="form-group {{ $errors->has('sample_two_link') ? 'has-error' : '' }}">
                ...
                <input type="text" id="sample_two_link" name="sample_one_link" class="form-control" value="{{ old('sample_two_link', isset($sample) ? $sample->sample_two_link : '') }}" required>
