                ...
                <div class="container">
                    <div style="align-items: center; display: flex; justify-content: center;" class="row">
                        ...
                        <div class="col-lg-4 col-md-6 mb-md-30">
                            <div style="background-image: url('{{ optional($category->photo)->getUrl('thumb') ?? asset('images/user-interface-design.png') }}');" class="feature-box-style-1">
                                ...
                                <div class="inner">
                                    <div class="front">
                                        ...
                                        <div style="align-items: center; display: flex; justify-content: center;">
                                            <a href="{{ route('categories.show', [$category->slug, $category->id]) }}" class="btn-custom scroll-to">View</a>
                                        </div>
                                    </div>
                                    <div class="info">
                                       <div class="row">
                                           ...
                                           <div class="col-md-12">
                                            <p style="align-items: center; display: flex; justify-content: center;">
                                                <a href="{{ route('categories.show', [$category->slug, $category->id]) }}" >View</a>
                                               </p>
                                           </div>
                                       </div>
                                    </div>
