            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route("admin.samples.index") }}" class="nav-link {{ request()->is('admin/samples') || request()->is('admin/samples/*') ? 'active' : '' }}">
                        ...
                        <p>
                            <span>{{ trans('cruds.sample.title') }}</span>
                        </p>
                    </a>
                </li>
            @endcan
                ...
                @can('project_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.projects.index") }}" class="nav-link {{ request()->is('admin/projects') || request()->is('admin/projects/*') ? 'active' : '' }}">
                            <i class="fa-fw fas fa-briefsample">
                ...
                @can('client_report_access')
                <li class="nav-item">
                    <a href="{{ route("admin.contacts.index") }}" class="nav-link {{ request()->is('admin/contacts') || request()->is('admin/contacys/*') ? 'active' : '' }}">
